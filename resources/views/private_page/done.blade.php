...
{{-- mainに入る部分 --}}
        <main id="main_container" class="flex justify-center">
            <div class="w-11/12 flex justify-center">
                <div class="bg-white h-auto w-2/3 md:w-2/5 rounded shadow-md shadow-gray-400 p-8 flex flex-col items-center">
                    <p class="text-sm md:font-base md:text-base mt-10 mb-4">ご予約ありがとうございます</p>
