...
<x-slot name="header">
    <div id="container" class="min-h-screen bg-gray-100">
        <div id="header_container" class="flex justify-center">
            <header class="w-11/12 flex items-center mt-4">
                    <button id="button" type="button" class="bg-blue-600 rounded p-1.5 text-white m-2 shadow-md shadow-gray-800 z-20">
                        <i id="bars">
...
{{-- mainに入る部分 --}}
        <div id="main_container" class="flex justify-center">
            <main class="w-11/12">
